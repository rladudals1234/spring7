...
<script>
  ...
  <div class="board-container">
    ...
    <table class="board-table">
      ...
      <tbody>
      <c:forEach var="board" items="${map.list}" step="1">
        <tr>
          <td>${board.bno}</td>
          <td class="title">
          	<a href="/board/bview/${board.bno}?category=${map.category}&search=${map.search}">
    ...
    <div class="board-footer" >
        <div class="pagination">
		    ...
		    <c:if test="${map.page > 1}">
		        <a href="/board/blist?page=${map.page - 1}&category=${map.category}&search=${map.search}">&laquo;</a>
		    </c:if>
		    ...
		    <c:if test="${map.page < map.maxPage}">
		        <a href="/board/blist?page=${map.page+1}&category=${map.category}&search=${map.search}">&raquo;</a>
		    </c:if>
        ...
        <form action="/board/blist" method="get" name="sFrm">
            ...
            <input type="text" name="search" value="${map.search}" placeholder="검색어 입력">
