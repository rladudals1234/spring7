...
<html>
	...
	<body>
		<header>
			<div id="nav_up">
				<ul>
					...
					<c:if test="${session_id != null}">
						<li><a href="/board/memberInfo">${session_name}님</a></li> <span>|</span>
		...
		<section>
			<form name="agree" method="get" action="/member/join02">
				...
				<div id="terms_button">
					<input type="reset" value="취소하기" onclick="javascript:location.href='/'"/>
