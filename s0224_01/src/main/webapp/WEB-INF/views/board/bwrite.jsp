...
<body>
  ...
  <div class="write-container">
    ...
    <form class="write-form" action="/board/bwrite" id="writeForm" name="writeFrm" method="post" enctype="multipart/form-data">
      <input type="text" id="writer" name="id" placeholder="작성자" maxlength="20" required />
