...
<body>
  ...
  <div class="container">
    ...
    <form action="/member/membership" method="post" id="mFrm" name="mFrm">
    <div class="form-box">
      <table>
        <tr>
        ...
        <tr>
          ...
          <td>
              <label for="M">남자</label><input type="radio" id="M" name="gender" value="M">
              <label for="F">여자</label><input type="radio" id="F" name="gender" value="F">
          </td>
        </tr>
        <tr>
          ...
          <td>
              ...
              <input type="checkbox" id="swim" name="hobby" value="수영"><label for="swim">수영</label>
    	...
    	function memBtn(e){
    		...
    		$.ajax({
	    		...
	    		success:function(data){
	    			console.log(data);
		    		alert(data.id+"님의 회원가입을 완료하셨습니다.");
	    		},
	    		error:function(err){
		    		err.message();
	    		}
    ...
    <div class="btn-box">
      ...
      <button type="button" class="btn submit" onclick="memBtn(event);">확인</button>
    </div>
      </form>
  </div>
  <footer></footer>
