...
<body>
  ...
  <div class="write-container">
    ...
    <form class="write-form" action="/board/bwrite" id="bFrm" name="bFrm" method="post" enctype="multipart/form-data">
      <input type="text" id="writer" name="id" name="id" value="${session_id}" readonly placeholder="작성자" maxlength="20" required />
